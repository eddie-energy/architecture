...
|[Adapter Devices](./devices/devices.md)| To connect with Metering Devices, AIIDA includes various Adapter Devices. This is important because each country may be using a different smart meter that requires a specific Adapter Device. Country-specific Adapter Devices are currently supported for Austria, France, Italy and more.|
