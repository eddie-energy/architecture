...
|-|-|-|-|-|
| 1 | Get Historical Validated Data| The EDDIE Framework needs to acquire historical validated data and provide it to the services. | To achieve this, the EDDIE Framework follows the approach of the Implementating Act by the Smart Grids Task Force. | [Link](../10-quality-requirements/compliance/implementing-act/implementing-act.md) |
| 2 | Consent Facade | All consumers shall provide their consent for sharing data in a homogeneous manner, regardless of their country or their Permission Administrator.| Implement a Consent Facade component based on the European Reference Process for providing consent. This component shall comply with the specificities of each country. | [Link](./consent-facade/consent-facade.md) |
