...
This table shows the supported IoT devices.

| To get IoT data | Adapter Device |
|-|-|
| Matter Devices | [Matter IoT Adapter Device](./iot-device-matter.md) |
