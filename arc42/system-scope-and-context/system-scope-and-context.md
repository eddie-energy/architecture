...
| AIIDA | The Administration Interface for In-house Data Access (AIIDA) implements the main workflows regarding accessing real-time data from in-house metering devices (e.g., smart meters), and sending it to the EDDIE Framework. |
