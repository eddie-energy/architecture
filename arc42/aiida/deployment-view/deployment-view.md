...
|Data Source| The Data Source is a device that sends energy-related data to the AIIDA Embedded App. Multiple Data Sources are supported, each one providing different connectivity options. The supported Data Sources and their connectivity are mentioned in the Data Source [section](../building-block-view/data-source/data-source). |
