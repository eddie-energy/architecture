...
| EP Website | The EP Website (Eligible Party Website) is a website offered by the eligible party as an interface for the customers. This website displays to the customer a customer permission form that collects all the necessary information to access the energy data of the customer. This form is provided by the EDDIE system which accesses the energy data from in-house metering devices and/or regional data-sharing infrastructures. |
