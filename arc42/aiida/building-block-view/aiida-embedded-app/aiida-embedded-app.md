...
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Aggregator         | Connects to the Data Source and collects the real-time energy data. This data is sent to the Streamer, and is also stored in the Timescale DB.                                                                                                                                                                                                  |
| Streamer           | Receives the real-time energy data from the Aggregator and sends it to the AIIDA Region Connector of the EDDIE Framework via MQTT.                                                                                                                                                                                                              |
| Permission Manager | Handles the customer permission for access to real-time data, and stores all related information in the Timescale DB. The Permission Manager also configures the Streamer to start streaming the data to the AIIDA Region Connector, when the customer permission has been granted.                                                             |
