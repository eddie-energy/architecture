...
|Adapter Device| The Adapter Device is a device that sends energy-related data to the AIIDA Embedded App. It may support various communication protocols depending on the connected device's specifications and requirements. All the supported Adapter Devices are mentioned in the  [Adapter Device section](../building-block-view/adapter-device/adapter-device.md). |
