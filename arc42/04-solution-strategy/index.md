...
|-|-|-|-|-|
| 1 | Get Historical Validated Data| The EDDIE Framework needs to acquire historical validated data and provide it to the services. | To achieve this, the EDDIE Framework follows the approach of the Implementating Act by the Smart Grids TaskForce. | [Link](../10-quality-requirements/compliance/implementing-act/implementing-act.md) |
