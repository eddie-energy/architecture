...
| User Device | Two user devices host the frontend applications. The Customer Mobile App typically runs in the smartphone of the customer, and the EP Web App is typically a web interface for the eligible party. |
