...
> The specific information that is needed by each country is summarized [here](../../data-models/data-model-consent-facade-interface/data-model-consent-facade-interface.md).
