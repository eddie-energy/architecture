...
| IAM | This is a Keycloak application utilized to manage the authentication, authorization, and access of customers and eligible parties. This application uses the Database to store user account information. The Customer Mobile App and EP Web App redirect account creation requests of users to IAM in order to store the user account details in the Database.|
