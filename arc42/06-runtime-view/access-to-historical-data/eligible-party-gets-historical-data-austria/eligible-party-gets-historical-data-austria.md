...
8. The Permission Facade asks the Interoperable Communication to set up a consent request in the selected Consent Admin Portal.
...
This workflow includes the following steps:
1. The Permission Facade which includes the micro frontend of Austria collects the required information from the consumer, and sends this information to the Translation Service.
