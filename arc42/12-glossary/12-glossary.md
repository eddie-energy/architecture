...
| Permission Provision Log                           | A timestamped record of when the permission for an eligible party or final customer was granted, revoked, or terminated, including a permission identifier, and a party identifier.                                                                                                                                                                            |
...
| Sub-meter                                          | A meter that measures only a part of a consumer's load/production behind one connection to the grid (measured by a main meter) or a meter with a different granularity of metering data than the main meter. |
