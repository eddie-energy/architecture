...
| EP Website | The EP Website (Eligible Party Website) is a website offered by the eligible party as an interface for the customers. This website presents an EDDIE Popup to the customer, which gathers all the necessary information to access their energy data. The EDDIE Popup is a user interface component provided by the EDDIE Framework that securely collects customer consent and relevant details, enabling the retrieval of energy data from in-house metering devices and/or regional data-sharing infrastructures. |
