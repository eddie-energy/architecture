...
1. The historical validated data is sent from the Regional Data-sharing Infrastructure to the Regional Connector (this component is discussed in subsection: Level 3 of Section: [Building Block View](../../../05-building-block-view/index.md)).
1. The Regional Connector forwards the data to the Message Producer (this component is discussed in subsection: Level 3 of Section: [Building Block View](../../../05-building-block-view/index.md)).
