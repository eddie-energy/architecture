...
| IAM | This is a Keycloak application utilized to manage the authentication, the authorization, and access of customers and eligible parties. It uses the Database to store account information.|
