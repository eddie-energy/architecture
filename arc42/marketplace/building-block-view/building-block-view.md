...
This section describes the building block view of the Data Services Marketplace system using the [C4 Model](https://c4model.com/). For this purpose, an overview of the corresponding containers is provided, along with their interactions. 
...
| Data Services Marketplace Backend | A backend application developed with Spring Boot, responsible for the core business logic of the Data Services Marketplace system. It handles requests from the PWA, manages customer and eligible party information, and enables the submission and browsing of data services and data hubs. 
| Database | A PostgreSQL database used by the Data Services Marketplace Backend to persist system data. It stores information such as eligible party details, submitted data services and data hubs, and customer-related data including ratings and comments. |
